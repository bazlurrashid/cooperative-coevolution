...
public class EvaluateAllFeatures {
	
	private static Double precision = 0.0;
	private static Double recall = 0.0;
	private static Double f1Score = 0.0;
	private static Double accuracy = 0.0;
	private static Double sensitivity = 0.0;
	private static Double specificity = 0.0;
	private static Double correctlyClassified = 0.0;
	...
	public EvaluateAllFeatures() throws Exception {
