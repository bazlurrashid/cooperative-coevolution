...
//		jTextArea.setEditable(true);
        ...
        jFrame.setTitle("CCEAFS: Cooperative Co-evolutionary Algorithm for Feature Selection");
        jFrame.setVisible(true);
        jFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        jFrame.pack();
        
        // Adding Listener to jOpenButton. 
        jOpenButton.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
            		...
            		if (pos > 0 && pos < (fileNameWithExtension.length() - 1)) { // If '.' is not the first or last character.
        ...
        // Adding Listener to jTestButton. 
        jTestButton.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
            		...
            		if (pos > 0 && pos < (testFileNameWithExtension.length() - 1)) { // If '.' is not the first or last character.
        ...
        jResetButton.addActionListener(new ActionListener() { 
            public void actionPerformed(ActionEvent e) { 
    	        ...
    	        if (button == jResetButton) {
    	        	...
    	        	jTextArea.append("\nCCEAFS resets to the beginning..." + "\n");
    	        	jResetButton.setEnabled(false);
    	        }
            } 
        });	// end of jStartButton.addActionListener
...
//	        	jTextArea.append("Classification Mode: " + classificationMode + "\n");
	        }
...
//	        	jTextArea.append("Classification Model: " + classificationModel + "\n");
	        }
	        else if (button == jSVM) {
